...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" id="txtUangBayar" name="txtUangBayar" class="form-control uang" placeholder="Enter the payment amount" oninput="calculateChange()" autofocus autocomplete="off" required/>
    </div>
</div>
